...
//#region node_modules/.nitro/vite/services/ssr/assets/validation-CwL44con.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-B9lfhbaE.mjs");
...
//#endregion
export { weightKg as _, optionalString as a, positiveId as c, restSec as d, rir as f, v as g, userIdStr as h, loadTag as i, repRange as l, shortText as m, dow as n, optionalText as o, sets as p, isoDate as r, parseOrThrow as s, authMiddleware as t, reps as u, workoutStatus as v };
