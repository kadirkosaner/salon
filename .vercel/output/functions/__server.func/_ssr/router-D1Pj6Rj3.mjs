...
import { _ as Navigate, c as HeadContent, d as createRouter, f as Outlet, h as createRootRoute, l as useRouterState, m as createFileRoute, p as lazyRouteComponent, s as Scripts } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime } from "../_libs/@radix-ui/react-collection+[...].mjs";
import { c as TriangleAlert } from "../_libs/lucide-react.mjs";
import { a as I18nProvider } from "./provider-DKU9A7zf.mjs";
...
import { t as Route$12 } from "./discover-DcAVto0q.mjs";
import { t as Route$13 } from "./reset-password-fxWZE2DR.mjs";
import { t as auth } from "./server-D5kQN1A-.mjs";
import { i as isOnboarded } from "./onboarding-CAcJWai0.mjs";
import { n as THEME_BOOT_SCRIPT, r as ThemeProvider } from "./provider-O8lqr3I3.mjs";
import { n as initPwa } from "./pwa-DZy85EaR.mjs";
import { t as Route$14 } from "./routes-Krjd_9So.mjs";
import { t as Route$15 } from "./workout-BI_WdUOc.mjs";
import { t as Route$16 } from "./u._username-D0gNKqRi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-D1Pj6Rj3.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-screen flex-col items-center justify-center gap-3 bg-canvas px-6 text-center text-text",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-danger",
				"aria-hidden": "true",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "size-10" })
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-md text-sm break-words text-text-2",
...
function OnboardingGate({ children }) {
	...
	const skip = !user || isPending || PUBLIC.has(pathname) || pathname.startsWith("/api/");
	const q = useQuery({
		queryKey: [
			"onboarding",
			"gate",
	...
	if (skip) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children });
	if (q.isLoading || q.isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	if (q.data && !q.data.onboarded && pathname !== "/welcome") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, { to: "/welcome" });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children });
}
/**
...
var styles_default = "/assets/styles-B5B_cTxP.css";
var APP_NAME = "Salon";
var APP_FULL_NAME = "Salon — Workout Tracker";
var APP_DESCRIPTION = "Workout tracker for iPhone and Android — programs, set logging, measurements and progress.";
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
					client: queryClient,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(I18nProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthProvider, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PwaBootstrap, {}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnboardingGate, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}) }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
							theme: "dark",
							position: "bottom-center",
							offset: { bottom: "5.5rem" },
							mobileOffset: { bottom: "5.5rem" },
							toastOptions: { className: "bg-sunken border-rule text-text" }
						})
					] }) }) })
				}),
...
var $$splitComponentImporter$8 = () => import("./login-Bgp1eoqS.mjs");
var Route$10 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./measurements-B7AbSyuP.mjs");
var Route$9 = createFileRoute("/measurements")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./notifications-CmgellTs.mjs");
var Route$8 = createFileRoute("/notifications")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./profile-C8ouNqAi.mjs");
var Route$7 = createFileRoute("/profile")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
/**
...
*/
var $$splitComponentImporter$4 = () => import("./program-HjbgJoHs.mjs");
var Route$6 = createFileRoute("/program")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./register-44N1K7Sm.mjs");
var Route$5 = createFileRoute("/register")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./settings-DJ8QeuvH.mjs");
var Route$4 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./welcome-BKZ-I8yI.mjs");
var Route$3 = createFileRoute("/welcome")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
...
*/
var Route$2 = createFileRoute("/api/ex-media")({ server: { handlers: { GET: async ({ request }) => {
...
var $$splitComponentImporter = () => import("./profile.edit-CpQdr0EB.mjs");
var Route$1 = createFileRoute("/profile/edit")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var MeasurementsRoute = Route$9.update({
	id: "/measurements",
	path: "/measurements",
	getParentRoute: () => Route$11
});
...
var ProgramRoute = Route$6.update({
	id: "/program",
	path: "/program",
	getParentRoute: () => Route$11
});
...
var WelcomeRoute = Route$3.update({
	id: "/welcome",
	path: "/welcome",
	getParentRoute: () => Route$11
});
var WorkoutRoute = Route$15.update({
	id: "/workout",
	path: "/workout",
	getParentRoute: () => Route$11
});
var ApiExMediaRoute = Route$2.update({
	id: "/api/ex-media",
	path: "/api/ex-media",
	getParentRoute: () => Route$11
});
var ProfileEditRoute = Route$1.update({
	id: "/edit",
	path: "/edit",
	getParentRoute: () => ProfileRoute
});
var UUsernameRoute = Route$16.update({
	id: "/u/$username",
	path: "/u/$username",
	getParentRoute: () => Route$11
});
...
var ProfileRouteChildren = { ProfileEditRoute };
var rootRouteChildren = {
	...
	MeasurementsRoute,
	NotificationsRoute,
	ProfileRoute: ProfileRoute._addFileChildren(ProfileRouteChildren),
	ProgramRoute,
	RegisterRoute,
	ResetPasswordRoute,
	SettingsRoute,
