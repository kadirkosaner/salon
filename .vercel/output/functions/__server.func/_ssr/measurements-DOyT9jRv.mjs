...
//#region node_modules/.nitro/vite/services/ssr/assets/measurements-DOyT9jRv.js
...
var listMeasurements = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(noInput).handler(listMeasurements_createServerFn_handler, async ({ context }) => {
