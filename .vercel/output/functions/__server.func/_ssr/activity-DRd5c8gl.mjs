...
import { c as positiveId, m as v, s as parseOrThrow, t as authMiddleware } from "./validation-y1g7FGMs.mjs";
import { t as createSsrRpc } from "./createSsrRpc-D75-wYbG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/activity-DRd5c8gl.js
...
var getDiscoverFeed = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("6cb0c44585db7d8adacdd8c95d252849c501333dca44120d4aa2c9fe7ec0d939"));
var getSuggestedAthletes = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("815336a91630b55d7790f232560835ec12ae22f07542e483fa2f63e840a3c607"));
...
}), d)).handler(createSsrRpc("423e37c6daeab9d0f4f6942a042f43d19935b23e347eff79c6b7bbfeae49a504"));
...
//#endregion
export { emitWorkoutCompleted as a, getSuggestedAthletes as c, unlikeActivity as d, emitProgramPublished as i, likeActivity as l, deleteActivity as n, getDiscoverFeed as o, emitPersonalRecordIfAny as r, getFeed as s, addComment as t, listComments as u };
