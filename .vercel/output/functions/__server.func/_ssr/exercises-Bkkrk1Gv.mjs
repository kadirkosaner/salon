...
import { browseDatasetByMuscle, ensureDatasetExercise, ensureExerciseLibrary, resolveDataset, searchDataset, t as exercises_dataset_slim_default } from "./seed-DlydNDJa.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/exercises-Bkkrk1Gv.js
/**
...
var listExercises = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(noInput).handler(listExercises_createServerFn_handler, async ({ context }) => {
