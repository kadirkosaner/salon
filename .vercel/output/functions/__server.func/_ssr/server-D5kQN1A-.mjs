import { $t as isProduction, At as runWithTransaction, C as toResponse, Ct as ATTR_OPERATION_ID, D as jwtVerify, Dt as getCurrentAdapter, E as decodeProtectedHeader, Et as getAuthTables, Ft as createRandomStringGenerator, Gt as createLogger, Kt as logger, Lt as base64Url, Mt as initGetModelName, Nt as initGetFieldName, Ot as queueAfterTransactionHook, Pt as generateId, Qt as isDevelopment, S as serializeSignedCookie, St as ATTR_HOOK_TYPE, T as decodeJwt, Tt as safeJSONParse, Vt as betterFetch, Wt as normalizePathname, X as encode, Yt as env, _ as runWithRequestState, _n as optional, a as createAuthorizationURL, b as createRouter$1, bt as withSpan, c as createRateLimitKey, ct as JWTExpired, d as deprecate, dn as boolean, en as isTest, f as createAuthEndpoint, fn as email, g as hasRequestState, gn as object, h as defineRequestState, hn as number, i as refreshAccessToken, in as BASE_ERROR_CODES, jt as getBetterAuthVersion, kt as runWithAdapter, l as findInvalidTrustedProxies, ln as any, m as isAPIError, mn as looseObject, n as socialProviders, nn as BetterAuthError, o as applyDefaultAccessTokenExpiry, p as createAuthMiddleware, qt as shouldPublishLog, r as validateAuthorizationCode, rn as kAPIErrorHeaderSymbol, s as isLoopbackHost, t as SocialProviderListEnum, tn as APIError, u as getIp, un as array, v as getCurrentAuthContext, vn as record, w as filterOutputFields, wt as import_src, x as serializeCookie, xt as ATTR_CONTEXT, y as runWithEndpointContext, yn as string } from "../_libs/@better-auth/core+[...].mjs";
import { n as string$1, t as boolean$1 } from "../_libs/zod.mjs";
import { n as getPglite, t as ensureDbReady } from "./db-DdbNJQxT.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-D5kQN1A-.js
...
var emailAndPasswordConfig = {
	...
	*/
	async sendResetPassword({ user, url }, _request) {
		...
		const from = process.env.EMAIL_FROM?.trim() || "Salon <onboarding@resend.dev>";
		if (key) {
		...
		console.info("[auth] password reset (set RESEND_API_KEY to email links)", user.email, url);
	}
};
