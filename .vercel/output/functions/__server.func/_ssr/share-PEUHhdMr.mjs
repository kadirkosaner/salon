...
//#region node_modules/.nitro/vite/services/ssr/assets/share-PEUHhdMr.js
...
var getPublicProgramDetail = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator((id) => id).handler(createSsrRpc("8ed95332c23efdc012d2d678efa7cc61217d2f31e89f6d84896e63e5d24a8fb0"));
var publishProgram = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("4312477b45dbbfc69b6ed18219f898c149adb6df6eb1777809c50fcf94a806a5"));
var updateProgramMeta = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("51a99a75ec2b797b2a652d1abc3b9af80ebab339ca49be6d184880428fbecbe2"));
/**
...
*/
var cloneProgram = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("2fdb5dc60c83dfbec29c79203d6e5f4f6c450805d2b8dc566f1fabcdf49a93b0"));
