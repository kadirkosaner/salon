...
import { E as LoaderCircle, J as ArrowDownRight, K as ArrowUpRight, d as Trash2, l as TrendingUp, u as TrendingDown, v as Scale, w as Minus, x as Plus } from "../_libs/lucide-react.mjs";
...
import { i as formatChartDate, n as ProgressAreaChart, t as MultiLineChart } from "./charts-BR2MOmCC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/olculer-nmdcl5Xs.js
...
var saveMeasurement = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("e70b887802d47d726afcf47a06dddba5f338a5cd98547832400a2c3259439f88"));
var deleteMeasurement = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((id) => id).handler(createSsrRpc("3c5511a3cd708b6e095746b8ac3a22c9e37285c642d9a134c0993487ec8c9a05"));
var METRICS = [
	{
		key: "body_weight",
		label: "Ağırlık",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, {
		...
		children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				tab === "charts" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, { hint: "Henüz ölçüm yok. Giriş sekmesinden ilk kaydı ekle — trend burada görünecek." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
				...
				tab === "history" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
					...
					children: rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, { hint: "Henüz ölçüm yok." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
