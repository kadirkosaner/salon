...
//#region node_modules/.nitro/vite/services/ssr/assets/share-C5nb_MX_.js
...
var listDiscoverPrograms = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(v(object({ locale: string().optional() }).optional())).handler(createSsrRpc("6d2b000444254eed06cba44d7955f6d54391af4ed14919699d492338be3cafcd"));
var getPublicProgramDetail = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(v(object({
	id: positiveId,
	locale: string().optional()
}))).handler(createSsrRpc("8ed95332c23efdc012d2d678efa7cc61217d2f31e89f6d84896e63e5d24a8fb0"));
...
}))).handler(createSsrRpc("2fdb5dc60c83dfbec29c79203d6e5f4f6c450805d2b8dc566f1fabcdf49a93b0"));
/** Leave / abandon current program entirely (no auto-replacement). */
var abandonProgram = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator(noInput).handler(createSsrRpc("75941c3f22f18a3c6aef4550ffa7bc1475c743df3a517aaebe8057f21412cb03"));
//#endregion
