...
import { i as slugFromIdentity, n as isValidUsername } from "./username-Bdxea3be.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/social-BjKrIrtg.js
...
var getMyProfileHub = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(noInput).handler(createSsrRpc("dcffd40a8afe60207067f5b87cecae9756d9504ba2c8232485aae25fbe0e1074"));
...
createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(noInput).handler(createSsrRpc("77aefd561628bc160bf92f337ebc8febab564be724c1bb0d561ff8b10d5edd2a"));
createServerFn({ method: "GET" }).middleware([authMiddleware]).validator(noInput).handler(createSsrRpc("807140b5c76a90c2fad6097751739cd559fc4f2f5bd23001e96fc44ee9a9ad30"));
...
var updateMyProfile = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator(v(profileUpdateSchema)).handler(createSsrRpc("ef6b1785d1951b525ca21d36ad0a0468815741b3ab610edc1a12ded206599685"));
...
var checkUsernameAvailable = createServerFn({ method: "GET" }).validator(v(object({ username: string().trim().min(1).max(32) }))).handler(createSsrRpc("019488682270bb85dd67c083bcc556d52cd4ef953bf253d5639a1abd4ee9ddb7"));
...
var claimRegisterUsername = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator(v(object({
	...
	height_cm: number().min(80).max(250).nullable().optional()
}))).handler(createSsrRpc("52a9f85993bcf84badbcc4b40dc94b6fefcc58acbba1bb30d1ee718b4338814e"));
//#endregion
export { getMyProfileHub as a, updateMyProfile as c, followUser as i, claimRegisterUsername as n, getUserProfile as o, ensureUserProfile as r, unfollowUser as s, checkUsernameAvailable as t };
